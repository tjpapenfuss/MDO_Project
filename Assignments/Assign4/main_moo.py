...
def experiment(input_tuple):
    ...
    combined = -NPV / 10000 + CAPEX_total / 1000000000
    print("The Value of the MOOU is: " + str(combined))
    
    # f = open('C:/Users/Beerstein/GitHub/MDO_Project/optimizer_output.csv', 'a')

    # # create the csv writer
    # writer = csv.writer(f)
    # row = [input_tuple[0],input_tuple[1],input_tuple[2],input_tuple[3],input_tuple[4],input_tuple[5],input_tuple[6],input_tuple[7],input_tuple[8],input_tuple[9],NPV,CAPEX_total,combined]
    # # row = [input_tuple,NPV,CAPEX_total,combined]
    ...
    p2, p4, p6, p8, p10, p12, NPV, (tot_co2_gen/1000000),CAPEX_total,-combined, q_inj,p_wf_t,mass_flow_rate_wells, pressure_wellhead]
    
    # Open our existing CSV file in append mode
    # Create a file object for this file
    with open('experiment_output_moo.csv', 'a', newline='') as f_object:
