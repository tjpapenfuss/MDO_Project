...
mtot_array = []
capex_array = []
experiment_tuple = (imported_df.loc[1]["Number of Wells"],
                        imported_df.loc[1]["Number of Connections"],
                        imported_df.loc[1]["Mass Flow Rate"],
                        imported_df.loc[1]["Pipeline Diameter"],
                        imported_df.loc[1]["Pipeline Length"],
                        imported_df.loc[1]["p2"],
                        imported_df.loc[1]["p4"],
                        imported_df.loc[1]["p6"],
                        imported_df.loc[1]["p8"],
                        imported_df.loc[1]["p10"],
                        imported_df.loc[1]["p12"])
