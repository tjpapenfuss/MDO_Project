...
hxfc =                  0 #Finance,HX Fuel costs,Cost of fuel needed to generate temperature difference for HX,$10.00 ,$1.50 ,$2.50 ,$/mmbtu
cpcc =                  0 #Finance,Comp Cost Coefficient,The per-unit cost for running the compressor (electricity),$0.40 ,$0.10 ,$0.20 ,$/kWh
discount_rate =         0 #Finance,Discount Rate,Assumed discount rate for project,,,10,diml